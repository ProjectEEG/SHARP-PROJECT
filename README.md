...
| `validation_.m` | Trains the multimodal stacking model using the discovery set and evaluates its performance in the external validation set, including ROC analysis and threshold-specific classification metrics. |
